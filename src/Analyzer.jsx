  ...
  const DetailModal = ({ result, fileContent, selectedFramework, subscription, onClose }) => {
    ...
    const handleGenerateText = async () => {
      ...
      try {
        ...
        const timeoutId = setTimeout(() => controller.abort(), 28000); // 28 second timeout (aligned with 25s backend timeout + buffer)
              ...
              {selectedFramework === 'NIST_800_53' && selectedCategories.length === 0 && (
               ...
               {selectedFramework === 'PCI_DSS' && (
                 <div className="mb-6">
                   ...
                   <div className="space-y-2">
                     {[
                       { code: 'Requirement 1: Install and Maintain Network Security Controls', displayCode: 'Req 1', name: 'Install and Maintain Network Security Controls', description: 'Processes and mechanisms for network security controls are defined and understood (v4.0.1)' },
                       { code: 'Requirement 2: Apply Secure Configurations to All System Components', displayCode: 'Req 2', name: 'Apply Secure Configurations to All System Components', description: 'Processes and mechanisms for secure configurations are defined and understood (v4.0.1)' },
                       { code: 'Requirement 3: Protect Stored Account Data', displayCode: 'Req 3', name: 'Protect Stored Account Data', description: 'Processes and mechanisms for protecting stored account data are defined and understood (v4.0.1)' },
                       { code: 'Requirement 4: Protect Cardholder Data with Strong Cryptography During Transmission', displayCode: 'Req 4', name: 'Protect Cardholder Data with Strong Cryptography During Transmission', description: 'Processes and mechanisms for protecting transmissions are defined and understood (v4.0.1)' },
                       { code: 'Requirement 5: Protect All Systems and Networks from Malicious Software', displayCode: 'Req 5', name: 'Protect All Systems and Networks from Malicious Software', description: 'Processes and mechanisms for anti-malware protection are defined and understood (v4.0.1)' },
                       { code: 'Requirement 6: Develop and Maintain Secure Systems and Software', displayCode: 'Req 6', name: 'Develop and Maintain Secure Systems and Software', description: 'Processes and mechanisms for developing and maintaining secure systems are defined and understood (v4.0.1)' },
                       { code: 'Requirement 7: Restrict Access to System Components and Cardholder Data', displayCode: 'Req 7', name: 'Restrict Access to System Components and Cardholder Data', description: 'Processes and mechanisms for restricting access are defined and understood (v4.0.1)' },
                       { code: 'Requirement 8: Identify Users and Authenticate Access to System Components', displayCode: 'Req 8', name: 'Identify Users and Authenticate Access to System Components', description: 'Processes and mechanisms for identifying users are defined and understood (v4.0.1)' },
                       { code: 'Requirement 9: Restrict Physical Access to Cardholder Data', displayCode: 'Req 9', name: 'Restrict Physical Access to Cardholder Data', description: 'Processes and mechanisms for restricting physical access are defined and understood (v4.0.1)' },
                       { code: 'Requirement 10: Log and Monitor All Access to System Components and Cardholder Data', displayCode: 'Req 10', name: 'Log and Monitor All Access to System Components and Cardholder Data', description: 'Processes and mechanisms for logging and monitoring are defined and understood (v4.0.1)' },
                       { code: 'Requirement 11: Test Security of Systems and Networks Regularly', displayCode: 'Req 11', name: 'Test Security of Systems and Networks Regularly', description: 'Processes and mechanisms for testing security are defined and understood (v4.0.1)' },
                       { code: 'Requirement 12: Support Information Security with Organizational Policies and Programs', displayCode: 'Req 12', name: 'Support Information Security with Organizational Policies and Programs', description: 'Processes and mechanisms for supporting information security are defined and understood (v4.0.1)' }
                     ].map(requirement => (
