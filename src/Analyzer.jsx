/*
  [BUILD WARNING FIX]
  If you are seeing a warning like '"import.meta" is not available in the configured target environment',
  it means your project's build configuration needs to be updated.

  To fix this, open the `vite.config.js` file in your project's main folder and
