...
const PrivacyPolicy = ({ onShowLogin, onShowSignup }) => {
  return (
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-8">
              <div className="prose prose-lg max-w-none prose-invert">
                <div className="bg-blue-900/50 border-l-4 border-blue-400 p-4 mb-6">
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-blue-300">Your Privacy Matters</h3>
                ...
                <h3 className="text-xl font-semibold text-slate-200 mt-6 mb-3">2.1 Information You Provide</h3>
                ...
                <h3 className="text-xl font-semibold text-slate-200 mt-6 mb-3">3.1 Primary Uses</h3>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-slate-200 mt-6 mb-3">3.2 AI Processing Details</h3>
                <div className="bg-yellow-900/50 border-l-4 border-yellow-400 p-4 mb-4">
                  <p className="text-yellow-200"><strong>Important:</strong> Your documents are processed by AI systems to generate compliance analysis. This processing is essential for our service delivery.</p>
                </div>
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-slate-600">
                        <th className="text-left py-2 text-slate-200">Data Type</th>
                        <th className="text-left py-2 text-slate-200">Retention Period</th>
                        <th className="text-left py-2 text-slate-200">Disposal Method</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b border-slate-600">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>Infrastructure partners maintain SOC 2 compliance and other certifications</li>
                ...
                <h3 className="text-xl font-semibold text-slate-200 mt-6 mb-3">6.1 We Do Not Share</h3>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-slate-200 mt-6 mb-3">6.2 Limited Sharing Scenarios</h3>
                <ul className="list-disc pl-6 space-y-2">
