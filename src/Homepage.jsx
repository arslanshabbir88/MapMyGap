            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <FeatureCard icon={<DocumentTextIcon className="w-8 h-8 text-purple-400" />} title="Automated Policy Generation">
                  Don't just find problems—solve them. AlignIQ generates ready-to-use policy text in your company's tone to fill identified gaps, saving you hours of writing.
                </FeatureCard>
