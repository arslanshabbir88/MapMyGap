// Comprehensive Compliance Framework Controls for Vercel Serverless Functions
  ...
  categories: [
    {
      ...
      results: [
        ...
        },
        {
          ...
          recommendation: "Implement least privilege access controls for all users and processes"
        },
        {
          id: "AC-7",
          control: "Unsuccessful Logon Attempts",
          status: "gap",
          details: "Unsuccessful logon attempt controls not implemented",
          recommendation: "Implement controls to limit unsuccessful logon attempts"
        },
        {
          id: "AC-8",
          control: "System Use Notification",
          status: "gap",
          details: "System use notification not implemented",
          recommendation: "Display system use notification to users before granting access"
        }
      ]
    },
    {
