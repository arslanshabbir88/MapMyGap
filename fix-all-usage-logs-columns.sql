...
ALTER TABLE usage_logs ADD COLUMN IF NOT EXISTS framework TEXT;
...
UPDATE usage_logs SET framework = 'NIST_CSF' WHERE framework IS NULL;
...
ALTER TABLE usage_logs ALTER COLUMN framework SET NOT NULL;
